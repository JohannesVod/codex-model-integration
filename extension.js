...
function activate(context) {
	...
	let disposable = vscode.commands.registerCommand('codex-model-integration.runCodex', function () {
	...
	let disposable3 = vscode.commands.registerCommand("extension.chatbotFunction", () => {
		vscode.window.showInformationMessage("Chatbot command executed");
	});

	let disposable4 = vscode.commands.registerCommand("extension.continueFunction", () => {
